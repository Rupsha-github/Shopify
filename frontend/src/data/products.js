export const products = [
  {
    ...
    price: 1499,
    description: "Comfortable slim fit joggers made from breathable cotton blend, perfect for workouts or casual wear.",
    categories: [
      {
        id: 1,
        name: "Men",
  ...
  },
  {
    ...
    price: 2499,
    description: "Lightweight floral summer dress with adjustable straps, ideal for casual outings and beach days.",
    categories: [
      {
        id: 2,
        name: "Women",
  ...
  },
  {
    ...
    price: 7999,
    description: "Minimalist wooden coffee table with a smooth finish, perfect for living rooms and lounges.",
    categories: [
      {
        id: 3,
        name: "Furniture",
  ...
  },
  {
    ...
    price: 3499,
    description: "Elegant leather handbag with structured design, flap closure, and long handles. Perfect for both casual and formal outings.",
    categories: [
      {
        id: 4,
        name: "Accessories",
  ...
  },
  {
    ...
    price: 8999,
    description: "A sleek ergonomic office chair with adjustable height, breathable mesh back, and cushioned seat for all-day comfort.",
    categories: [
      {
        id: 5,
        name: "Furniture",
  ...
  },
  {
    ...
    price: 4999,
    description: "Premium wireless headphones with noise cancellation, cushioned ear cups, and long battery life. Ideal for music and work.",
    categories: [
      {
        id: 6,
        name: "Electronics",
  ...
  },
  {
    ...
    price: 15999,
    description: "Spacious wooden dining table with six chairs, crafted from durable hardwood. Perfect for family meals and gatherings.",
    categories: [
      {
        id: 7,
        name: "Furniture",
  ...
  },
  {
    ...
    price: 2999,
    description: "Lightweight running shoes with cushioned sole and breathable mesh upper. Designed for performance and everyday wear.",
    categories: [
      {
        id: 13,
        name: "Footwear",
  ...
  },
  {
    ...
    price: 3299,
    description: "Breathable mesh sneakers designed for running and training. Lightweight sole with excellent grip and cushioning.",
    categories: [
      {
        id: 2,
        name: "Women",
  ...
  },
  {
    ...
    price: 6999,
    description: "Modern smartwatch with heart rate monitor, step counter, and customizable watch faces. Compatible with iOS and Android.",
    categories: [
      {
        id: 6,
        name: "Electronics",
  ...
  },
  {
    ...
    price: 5999,
    description: "Tall wooden bookshelf with five spacious shelves, perfect for organizing books, decor, and storage baskets.",
    categories: [
      {
        id: 3,
        name: "Furniture",
  ...
  },
  {
    ...
    price: 1299,
    description: "Classic brown leather wallet with multiple card slots, cash compartment, and RFID protection.",
    categories: [
      {
        id: 1,
        name: "Men",
  ...
  },
  {
    ...
    price: 1999,
    description: "Stylish oversized sunglasses with UV protection lenses. Perfect for sunny days and fashion statements.",
    categories: [
      {
        id: 2,
        name: "Women",
  ...
  },
  {
    ...
    price: 4499,
    description: "Classic navy blue blazer tailored for a sharp fit. Perfect for office wear and formal occasions.",
    categories: [
      {
        id: 1,
        name: "Men",
  ...
  },
  {
    ...
    price: 5999,
    description: "Warm wool blend coat with button closure and belt tie. Stylish and cozy for cold weather.",
    categories: [
      {
        id: 2,
        name: "Women",
  ...
  },
  {
    ...
    price: 2999,
    description: "Compact wireless speaker with deep bass and 12-hour battery life. Perfect for travel and parties.",
    categories: [
      {
        id: 6,
        name: "Electronics",
  ...
  },
  {
    ...
    price: 18999,
    description: "Queen-size wooden bed frame with sturdy construction and minimalist design. Adds elegance to any bedroom.",
    categories: [
      {
        id: 3,
        name: "Furniture",
  ...
  },
  {
    ...
    price: 999,
    description: "Soft cotton crew neck t-shirt in solid colors. Everyday essential for layering or casual wear.",
    categories: [
      {
        id: 1,
        name: "Men",
  ...
  },
  {
    ...
    price: 1799,
    description: "Stretchable high-waist leggings designed for yoga and workouts. Breathable fabric with snug fit.",
    categories: [
      {
        id: 2,
        name: "Women",
  ...
  },
  {
    ...
    price: 3499,
    description: "High-power blender with multiple speed settings and durable glass jar. Perfect for smoothies and cooking.",
    categories: [
      {
        id: 6,
        name: "Electronics",
  ...
  },
  {
    ...
    price: 1299,
    description: "Handcrafted ceramic vase with a matte finish. Perfect for fresh flowers or dried stems to elevate your home decor.",
    categories: [
      {
        id: 10,
        name: "Home Decor",
  ...
  },
  {
    ...
    price: 2499,
    description: "Minimalist bedside lamp with a warm LED glow and wooden base. adjustable brightness for reading.",
    categories: [
      {
        id: 10,
        name: "Home Decor",
  ...
  },
  {
    ...
    price: 899,
    description: "Live indoor rubber plant in a decorative white pot. Low maintenance and purifies air naturally.",
    categories: [
      {
        id: 10,
        name: "Home Decor",
  ...
  },
  {
    ...
    price: 1899,
    description: "Nutrient-rich dry dog food with real chicken and vegetables. Supports healthy digestion and shiny coat.",
    categories: [
      {
        id: 16,
        name: "Pet Food",
  ...
  },
  {
    ...
    price: 499,
    description: "Pack of 6 wet cat food pouches. Tuna and salmon flavor, rich in Omega-3 for heart health.",
    categories: [
      {
        id: 16,
        name: "Pet Food",
    ...
    images: ["https://www.shutterstock.com/image-photo/bucharest-romania-march-14-2024-600nw-2439920335.jpg"],
    inStock: false,
  ...
  },
  {
    ...
    price: 999,
    description: "Brightening face serum with 10% Vitamin C and Hyaluronic Acid. Reduces dark spots and hydrates skin.",
    categories: [
      {
        id: 17,
        name: "Beauty",
  ...
  },
  {
    ...
    price: 1199,
    description: "Eco-friendly yoga mat with extra cushioning and non-slip texture. Ideal for yoga, pilates, and home workouts.",
    categories: [
      {
        id: 18,
        name: "Sports",
  ...
  },
  {
    ...
    price: 3299,
    description: "Water-resistant travel backpack with dedicated laptop compartment and USB charging port.",
    categories: [
      {
        id: 4,
        name: "Accessories",
  ...
  },
  {
    ...
    price: 4599,
    description: "Compact drip coffee maker with reusable filter and keep-warm function. Brews up to 6 cups at once.",
    categories: [
      {
        id: 15,
        name: "Kitchen Appliances",
  ...
  },
  {
    ...
    price: 2199,
    description: "Large framed abstract canvas print in neutral tones. Adds a modern touch to living rooms or offices.",
    categories: [
      {
        id: 10,
        name: "Home Decor",
